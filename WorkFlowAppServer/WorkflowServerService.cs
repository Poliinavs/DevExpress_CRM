...
namespace WorkFlowAppServer.WorkflowServerService {
    public partial class WorkFlowAppServerWorkflowServer  : System.ServiceProcess.ServiceBase {
        private WorkflowServer server;
        protected override void OnStart(string[] args) {
            if(server == null) {
                ServerApplication serverApplication = new ServerApplication();
                serverApplication.ApplicationName = "WorkFlowAppServer";
                ...
                serverApplication.Modules.Add(new CRM.Module.CRMModule());
        ...
        public WorkFlowAppServerWorkflowServer() {
            InitializeComponent();
        }
    }
}
